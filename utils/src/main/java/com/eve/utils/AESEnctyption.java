...
public class AESEnctyption {
    public static byte[] encrypt(byte[] plaintext, SecretKey key, byte[] IV) throws Exception {   /*Şifreleme sınıfı, gerçek şifreleme ve şifre çözme işlemlerini yapan sınıftır. Cipher sınıfı örneği, Cipher adını parametre olarak geçiren getInstance () yöntemi çağrılarak oluşturulur, biz AES/CBC/PKCS5Padding kullandık.*/
